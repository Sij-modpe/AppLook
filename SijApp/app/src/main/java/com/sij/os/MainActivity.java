...
public class MainActivity extends AppCompatActivity 
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//		 Toast.makeText(MainActivity.this, "本软件已开源于github", Toast.LENGTH_SHORT).show();
	...
	public boolean onCreateOptionsMenu(Menu menu){
		//menu.add(Menu.NONE,5,1,"关于作者");
		menu.add(Menu.NONE,6,2,"退出程序");
		menu.add(Menu.NONE,7,3,"帮助/about");
		//menu.add(Menu.NONE,8,4,"debug(调试)");
		menu.add(Menu.NONE,9,5,"GitHub地址");
		return true;
	}
		...
		switch(item.getItemId()){
			...
			case 7:
				...
				/*		case 8:
				 ...
				 off();
				 //  Toast.makeText(MainActivity.this,MainActivity.listToString(packages) , Toast.LENGTH_SHORT).show();


				 break;*/
			case 9:
				//跳转至GITHUB仓库(使用系统自带浏览器)
				Uri uri = Uri.parse("https://github.com/Sij-modpe/AppLook"); 
...
//	       Toast.makeText(MainActivity.this, ""+item.getItemId(), Toast.LENGTH_SHORT).show();
	...
	/*public static String listToString(List<PackageInfo> list) {
